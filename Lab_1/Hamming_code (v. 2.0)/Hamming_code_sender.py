...
Hamming_mas = functions.Hamming_code(bit_mas, length_hamming_word_input, 0)
...
count_of_zero_errors = functions.bin_dec(list(conn_1.recv(1024)))
...
count_of_one_errors = functions.bin_dec(list(conn_3.recv(1024)))
...
count_of_two_errors = functions.bin_dec(list(conn_4.recv(1024)))
...
if(print_information):
    print("Количество правильно переданных слов -", count_of_zero_errors)
    print("Количество неправильно переданных слов -", count_of_false_words)
    print("Количество исправленных слов -", count_of_one_errors)
    print("Количество неисправленных слов -", count_of_two_errors)
else:
    file = open("texts/accepted_text_information.txt", "w")
    s = "Количество переданных слов без ошибок - " + str(count_of_zero_errors) + "\n"
    s = s + "Количество переданных слов с одной ошибкой - " + str(count_of_one_errors) + "\n"
    s = s + "Количество переданных слов с двумя ошибками - " + str(count_of_two_errors)
    file.write(s)
    file.close()