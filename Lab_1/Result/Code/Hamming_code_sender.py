...
encoding = functions.get_encoding(path_3)
...
file_text = functions.read_file(path_3, en) # Исходный файл
...
Hamming_mas = functions.Hamming_code(bit_mas, length_hamming_word_input, 1)
